    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div id="about">
          <p><a href="index">Studying Smart</a> is a web portal with a slogan: “KNOWLEDGE IS FREE”, so it is place for users to get e-books.

</p><p>Moreover, all of material here is the result of hard work from someone else, you should appreciate and respect the authors purchase the book if they have helped you earn money or improve your career.
</p><p>We are providing vast collection of free e-books which are very helpful to the students of 
engineering, law, medical, management and commerce field. 
Online PDF`s of all the types of authors are available those who aim to study and access the content on just few clicks.</p>
		  </div>
        </div>
