...
<style>
#loading{width:500px;position:absolute;}
#pagination{text-align:center;margin-left:200px;}
#pagination li{list-style:none;float:left;margin-right:16px;padding:5px;border:solid 1px #dddddd;color:#0063DC; background:#;}
...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class='center_title_bar'>Our Books</div>
    <div align="center">
 		<div id="content" ></div>
			<table width="800px">
			<tr><Td>
