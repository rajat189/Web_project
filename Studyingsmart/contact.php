  ...
  <div id="main_content">
    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <form name="contactform" method="post" action="send_form_email" enctype="multipart/form-data">
            <div class="form_row">
              <label class="contact"><strong>First Name:</strong></label>
              <input name="first_name" type="text" class="contact_input" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Last Name:</strong></label>
              <input name="last_name" type="text" class="contact_input" />
            </div>
            <div class="form_row">
            ...
            <div class="form_row">
              <label class="contact"><strong>Phone No.:</strong></label>
              <input name="telephone" type="text" class="contact_input" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Message:</strong></label>
              <textarea name="comments" class="contact_textarea" ></textarea>
            </div>
